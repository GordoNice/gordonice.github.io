...
P_{\text{cross}}=\frac{\text{area under the curve}}{area of the rectangle}б
$$
...
So, here we get the result from eq. \eqref{eq:prob}.
...
$\hat{P}\_{\text{cross}}\approx\frac{2L}{\pi D}$ or $\pi\approx\frac{2L}{\hat{P}\_{\text{cross}} D}$
